...
public class SecurityManager {
    ...
    public boolean verifyPin(byte[] inputKey, short off) {
        ...
        //  KIM TRA KHÓA ADMIN TRÝC (Ýu tiên cao nht)
        if (isCardLocked) ISOException.throwIt((short) 0x6283); 
        
        // Sau ðó mi kim tra pinTries
        ...
        if (match) {
            ...
            //  T ÐNG KHÓA KHI NHP SAI 3 LN
            if (pinTries == 0) {
                isCardLocked = true; 
    ...
    //  Admin khóa th - HOT ÐNG TRC TIP
    ...
    //  Admin m khóa th - HOT ÐNG TRC TIP
    ...
    public void resetPin(byte[] newKeyBuffer, short off) {
        ...
        pinTries = MAX_RETRY;
        isCardLocked = false;
        // Reset xong không t ðng validate, User vn phi verifyPin bng m mi
        isValidated = false; 
    }
